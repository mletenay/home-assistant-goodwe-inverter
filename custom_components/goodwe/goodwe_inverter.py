...
class ET(Inverter):
    ...
    __sensors = (
        ...
        ("work_mode", 174, _read_work_mode, "", "Work Mode", None),
...
class ES(Inverter):
    ...
    __sensors = (
        ...
        ("battery_mode", 30, _read_battery_mode1, "", "Battery Mode", _ICON_BATT),
        ...
        ("grid_mode", 42, _read_work_mode1, "", "Work Mode", None),
        ...
        ("load_mode", 51, _read_load_mode1, "", "Load Mode", None),
        ("work_mode", 52, _read_energy_mode1, "", "Energy Mode", None),
